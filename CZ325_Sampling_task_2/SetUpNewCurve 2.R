...
Curve = read.csv(here::here("HOBS_14C_CalCurve_PredictedVals_20230524.csv"))
Combined14C_forFLCalCurve = read.csv(here::here("CZ325_Sampling_task_2/Combined14C_forFLCalCurve.csv"))
...
write.table(Curve, here::here("HOBS_14C_CalCurve_PredictedVals_20230524.14c"), sep = "\t", row.names = FALSE, quote = FALSE)
curvename = "HOBS_14C_CalCurve_PredictedVals_20230524"
curvepath = here::here("HOBS_14C_CalCurve_PredictedVals_20230524.14c")
