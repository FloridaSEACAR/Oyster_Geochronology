...
```{r}
Goose_Island_East_Cove_R4H3S1_results %>% reshape2::melt("n") %>% ggplot(aes(x = n, y = value)) + geom_jitter(width = 0.2) + geom_smooth(color = "orange") + facet_wrap(~variable) + ggtitle("Goose Island/East Cove Reef 4")
```
